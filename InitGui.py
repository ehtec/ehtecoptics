...
class ehtecOptics(Workbench):
    ...
    def Initialize(self):
        ...
        self.list = ["Convert_To_Lens", "Convert_To_Absorber", "Convert_To_Mirror", "Single_Ray_Laser",
                     "Rectangular_Laser", "Circular_Laser",
                     "Render"]  # A list of command names created in the line above
